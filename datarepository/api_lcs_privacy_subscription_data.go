...
func HttpQueryLcsPrivacyData(c *gin.Context) {
	logger.HandlerLog.Infof("QueryLcsPrivacyData is called")
	...
	rsp := HandleQueryLcsPrivacyData( ueId,fields,supportedFeatures,ifNoneMatch,ifModifiedSince, c)
