...
func HttpQueryLcsBcaData(c *gin.Context) {
	logger.HandlerLog.Infof("QueryLcsBcaData is called")
	...
	rsp := HandleQueryLcsBcaData( ueId,servingPlmnId,supportedFeatures,ifNoneMatch,ifModifiedSince, c)
