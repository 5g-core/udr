...
func HttpCreateSdmSubscriptions(c *gin.Context) {
	logger.HandlerLog.Infof("CreateSdmSubscriptions is called")
	...
	rsp := HandleCreateSdmSubscriptions( ueId,sdmSubscription, c)
...
func HttpQuerysdmsubscriptions(c *gin.Context) {
	logger.HandlerLog.Infof("Querysdmsubscriptions is called")
    /// <param name="ueId type: string">UE id</param>
	...
	rsp := HandleQuerysdmsubscriptions( ueId,supportedFeatures, c)
