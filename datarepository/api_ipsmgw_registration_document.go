...
func HttpCreateIpSmGwContext(c *gin.Context) {
	logger.HandlerLog.Infof("CreateIpSmGwContext is called")
    /// <param name="ueId type: string">UE id</param>
    /// <param name="ipSmGwRegistration type: IpSmGwRegistration"></param>
    // Getting the path params
	ueId :=c.Params.ByName("ueId")
	// get and parse body
	var ipSmGwRegistration IpSmGwRegistration
	if err := getDataFromRequestBody(c, &ipSmGwRegistration); err != nil {
	...
	rsp := HandleCreateIpSmGwContext( ueId,ipSmGwRegistration, c)
...
func HttpDeleteIpSmGwContext(c *gin.Context) {
	logger.HandlerLog.Infof("DeleteIpSmGwContext is called")
    /// <param name="ueId type: string">UE id</param>
    // Getting the path params
	ueId :=c.Params.ByName("ueId")
	rsp := HandleDeleteIpSmGwContext( ueId, c)
...
func HttpModifyIpSmGwContext(c *gin.Context) {
	logger.HandlerLog.Infof("ModifyIpSmGwContext is called")
    /// <param name="ueId type: string">UE id</param>
	...
	rsp := HandleModifyIpSmGwContext( ueId,patchItem, c)
...
func HttpQueryIpSmGwContext(c *gin.Context) {
	logger.HandlerLog.Infof("QueryIpSmGwContext is called")
    /// <param name="ueId type: string">UE id</param>
	...
	rsp := HandleQueryIpSmGwContext( ueId,fields,supportedFeatures, c)
