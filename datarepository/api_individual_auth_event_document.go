...
func HttpDeleteIndividualAuthenticationStatus(c *gin.Context) {
	logger.HandlerLog.Infof("DeleteIndividualAuthenticationStatus is called")
	...
	rsp := HandleDeleteIndividualAuthenticationStatus( ueId,servingNetworkName, c)
...
func HttpQueryIndividualAuthenticationStatus(c *gin.Context) {
	logger.HandlerLog.Infof("QueryIndividualAuthenticationStatus is called")
    /// <param name="ueId type: string">UE id</param>
    /// <param name="servingNetworkName type: string">Serving Network Name</param>
	...
	rsp := HandleQueryIndividualAuthenticationStatus( ueId,servingNetworkName,fields,supportedFeatures, c)
