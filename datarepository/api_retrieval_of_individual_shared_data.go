...
func HttpGetIndividualSharedData(c *gin.Context) {
	logger.HandlerLog.Infof("GetIndividualSharedData is called")
    /// <param name="sharedDataId type: SharedDataIds">Id of the Shared data</param>
	...
	rsp := HandleGetIndividualSharedData( sharedDataId,ifNoneMatch,ifModifiedSince, c)
