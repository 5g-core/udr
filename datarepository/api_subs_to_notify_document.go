...
func HttpModifysubscriptionDataSubscription(c *gin.Context) {
	logger.HandlerLog.Infof("ModifysubscriptionDataSubscription is called")
	...
	rsp := HandleModifysubscriptionDataSubscription( subsId,patchItem,supportedFeatures, c)
...
func HttpQuerySubscriptionDataSubscriptions(c *gin.Context) {
	logger.HandlerLog.Infof("QuerySubscriptionDataSubscriptions is called")
    /// <param name="subsId type: string">Unique ID of the subscription to retrieve</param>
    // Getting the path params
	subsId :=c.Params.ByName("subsId")
	rsp := HandleQuerySubscriptionDataSubscriptions( subsId, c)
...
func HttpRemovesubscriptionDataSubscriptions(c *gin.Context) {
	logger.HandlerLog.Infof("RemovesubscriptionDataSubscriptions is called")
    /// <param name="subsId type: string">Unique ID of the subscription to remove</param>
    // Getting the path params
	subsId :=c.Params.ByName("subsId")
	rsp := HandleRemovesubscriptionDataSubscriptions( subsId, c)
