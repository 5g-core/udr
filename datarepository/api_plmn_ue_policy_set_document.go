...
func HttpReadPlmnUePolicySet(c *gin.Context) {
	logger.HandlerLog.Infof("ReadPlmnUePolicySet is called")
    /// <param name="plmnId type: string"></param>
    // Getting the path params
	plmnId :=c.Params.ByName("plmnId")
	rsp := HandleReadPlmnUePolicySet( plmnId, c)
