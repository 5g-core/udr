...
func HttpCreateSmsfContextNon3gpp(c *gin.Context) {
	logger.HandlerLog.Infof("CreateSmsfContextNon3gpp is called")
	...
	rsp := HandleCreateSmsfContextNon3gpp( ueId,smsfRegistration, c)
...
func HttpDeleteSmsfContextNon3gpp(c *gin.Context) {
	logger.HandlerLog.Infof("DeleteSmsfContextNon3gpp is called")
    /// <param name="ueId type: string">UE id</param>
    // Getting the path params
	ueId :=c.Params.ByName("ueId")
	rsp := HandleDeleteSmsfContextNon3gpp( ueId, c)
...
func HttpQuerySmsfContextNon3gpp(c *gin.Context) {
	logger.HandlerLog.Infof("QuerySmsfContextNon3gpp is called")
    /// <param name="ueId type: string">UE id</param>
	...
	rsp := HandleQuerySmsfContextNon3gpp( ueId,fields,supportedFeatures, c)
