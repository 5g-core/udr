...
func HttpCreateHSSSDMSubscriptions(c *gin.Context) {
	logger.HandlerLog.Infof("CreateHSSSDMSubscriptions is called")
	...
	rsp := HandleCreateHSSSDMSubscriptions( ueId,subsId,hssSubscriptionInfo, c)
...
func HttpGetHssSDMSubscriptionInfo(c *gin.Context) {
	logger.HandlerLog.Infof("GetHssSDMSubscriptionInfo is called")
    /// <param name="ueId type: string"></param>
    /// <param name="subsId type: string"></param>
    // Getting the path params
	ueId :=c.Params.ByName("ueId")
	subsId :=c.Params.ByName("subsId")
	rsp := HandleGetHssSDMSubscriptionInfo( ueId,subsId, c)
...
func HttpModifyHssSDMSubscriptionInfo(c *gin.Context) {
	logger.HandlerLog.Infof("ModifyHssSDMSubscriptionInfo is called")
    /// <param name="ueId type: string"></param>
    /// <param name="subsId type: string"></param>
	...
	rsp := HandleModifyHssSDMSubscriptionInfo( ueId,subsId,patchItem,supportedFeatures, c)
...
func HttpRemoveHssSDMSubscriptionsInfo(c *gin.Context) {
	logger.HandlerLog.Infof("RemoveHssSDMSubscriptionsInfo is called")
    /// <param name="ueId type: string"></param>
    /// <param name="subsId type: string"></param>
    // Getting the path params
	ueId :=c.Params.ByName("ueId")
	subsId :=c.Params.ByName("subsId")
	rsp := HandleRemoveHssSDMSubscriptionsInfo( ueId,subsId, c)
