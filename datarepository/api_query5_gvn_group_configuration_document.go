...
func HttpGet5GVnGroupConfiguration(c *gin.Context) {
	logger.HandlerLog.Infof("Get5GVnGroupConfiguration is called")
    /// <param name="externalGroupId type: string"></param>
    // Getting the path params
	externalGroupId :=c.Params.ByName("externalGroupId")
	rsp := HandleGet5GVnGroupConfiguration( externalGroupId, c)
