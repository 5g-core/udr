...
func HttpQuerySmfSelectData(c *gin.Context) {
	logger.HandlerLog.Infof("QuerySmfSelectData is called")
	...
	rsp := HandleQuerySmfSelectData( ueId,servingPlmnId,fields,supportedFeatures,ifNoneMatch,ifModifiedSince, c)
