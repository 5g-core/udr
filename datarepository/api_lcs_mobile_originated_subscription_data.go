...
func HttpQueryLcsMoData(c *gin.Context) {
	logger.HandlerLog.Infof("QueryLcsMoData is called")
	...
	rsp := HandleQueryLcsMoData( ueId,fields,supportedFeatures,ifNoneMatch,ifModifiedSince, c)
