...
func HttpCreateSharedData(c *gin.Context) {
	logger.HandlerLog.Infof("CreateSharedData is called")
    /// <param name="sharedDataId type: string">Id of the Shared data</param>
    /// <param name="sharedData type: SharedData"></param>
    // Getting the path params
	sharedDataId :=c.Params.ByName("sharedDataId")
	// get and parse body
	var sharedData SharedData
	if err := getDataFromRequestBody(c, &sharedData); err != nil {
	...
	rsp := HandleCreateSharedData( sharedDataId,sharedData, c)
