...
func HttpQueryCoverageRestrictionData(c *gin.Context) {
	logger.HandlerLog.Infof("QueryCoverageRestrictionData is called")
	...
	rsp := HandleQueryCoverageRestrictionData( ueId,supportedFeatures,ifNoneMatch,ifModifiedSince, c)
