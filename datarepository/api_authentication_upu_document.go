...
func HttpCreateAuthenticationUPU(c *gin.Context) {
	...
	// get and parse body
	var upuData UpuData
	if err := getDataFromRequestBody(c, &upuData); err != nil {
	...
	rsp := HandleCreateAuthenticationUPU( ueId,supportedFeatures,upuData, c)
...
func HttpQueryAuthUPU(c *gin.Context) {
	logger.HandlerLog.Infof("QueryAuthUPU is called")
    /// <param name="ueId type: string">UE id</param>
    /// <param name="supportedFeatures type: string">Supported Features (optional)</param>
    // Getting the path params
	ueId :=c.Params.ByName("ueId")
	...
	supportedFeatures := queryParams[""]
	rsp := HandleQueryAuthUPU( ueId,supportedFeatures, c)
