...
func HttpQueryContextData(c *gin.Context) {
	logger.HandlerLog.Infof("QueryContextData is called")
    /// <param name="ueId type: string">UE id</param>
    /// <param name="contextDatasetNames type: ContextDatasetNames">List of context dataset names</param>
    // Getting the path params
	ueId :=c.Params.ByName("ueId")
	// Getting query params 
	queryParams := c.Request.URL.Query()
	// query parameter : basename context-dataset-names paramName contextDatasetNames
	contextDatasetNames := queryParams[""]
	rsp := HandleQueryContextData( ueId,contextDatasetNames, c)
