...
func HttpQuery5GVnGroup(c *gin.Context) {
	logger.HandlerLog.Infof("Query5GVnGroup is called")
    /// <param name="gpsis type: []string">List of GPSIs (optional)</param>
	// Getting query params 
	queryParams := c.Request.URL.Query()
	// query parameter : basename gpsis paramName gpsis
	gpsis := queryParams[""]
	rsp := HandleQuery5GVnGroup( gpsis, c)
